...
rm -rf scripts/vendors/* build scripts/filters scripts/factories scripts/services scripts/controllers scripts/directives scripts/router.js scripts/app.js build.txt 
